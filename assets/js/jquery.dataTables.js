...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var features = settings.aanFeatures;
                /*
                 * 
                 *  @hook se cambio para hacer que funcione el texto en español
                 * 
                 */
		var input = '<input type="text" placeholder="buscar" class="'+classes.sFilterInput+' form-control"/>';
		...
		var jqFilter = $('input', filter)
			...
			//.attr( 'placeholder', language.sSearchPlaceholder ) /* aqui se ajusta el placeholder*/
			.bind(
